    ...
    if (sesion.estado === 'inicio') {
        ...
        if (!clienteDB || !clienteDB.direccion) {
            ...
            await Conversacion.create({
                ...
                pedido: texto,
                direccion: clienteDB ? clienteDB.direccion : '',
                mensajes: [{ de: 'cliente', texto: texto }]
            });
